Solution for the kaggle toxic comments classification challenge is given below-
...
submission.to_csv("lgbm_clean_submission.csv", index=False, float_format="%.8f")
